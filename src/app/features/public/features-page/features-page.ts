...
export class FeaturesPageComponent {
  readonly page: FeaturesPageConfig = {
    hero: {
      ...
      image: { src: '/assets/img/bee2.webp', alt: 'Ink illustration of a honeybee seen from above', width: 473, height: 473, priority: true },
    ...
    splitListsPre: [
      {
        ...
        cta: { label: 'Hive inspection records »', routerLink: '/inspections' },
      },
      {
        ...
        cta: { label: 'Apiary and beehive management »', routerLink: '/apiariesandbeehives' },
      },
      {
        ...
        cta: { label: 'The voice beekeeping app »', routerLink: '/app' },
      },
    ],
    ribbon: {
      mode: 'dark',
    ...
    splitListsPost: [
      {
        ...
        image: { src: '/assets/img/jar.webp', alt: 'Ink illustration of a honey jar with a cloth cover', width: 473, height: 473 },
        items: [
        ...
        cta: { label: 'Beekeeping cost and income tracking »', routerLink: '/financial' },
      },
      {
        title: "Keep control of the feedings 'n' harvests",
        image: { src: '/assets/img/comb.webp', alt: 'Ink illustration of honeycomb dripping with honey', width: 473, height: 473 },
        items: [
        ...
        cta: { label: 'Honey harvest and feeding records »', routerLink: '/harvestandfeeding' },
      },
    ],
    ctaBanner: {
      ...
      secondary: { label: 'The beekeeping blog »', routerLink: '/blog' },
    },
  };
