...
export const SEO_CONFIG: Record<string, SEOModel> = {
  ...
  app: {
    ...
    robots: 'index, follow',
    image_url: `${BASE}/assets/images/og-app.jpg`,
  ...
  apiariesAndBeehives: {
    ...
    robots: 'index, follow',
    image_url: `${BASE}/assets/images/og-apiaries.jpg`,
  ...
  financial: {
    ...
    robots: 'index, follow',
    image_url: `${BASE}/assets/images/og-financial.jpg`,
  ...
  harvestAndFeeding: {
    ...
    robots: 'index, follow',
    image_url: `${BASE}/assets/images/og-harvest-feeding.jpg`,
  ...
  inspections: {
    ...
    robots: 'index, follow',
    image_url: `${BASE}/assets/images/og-inspections.jpg`,
  ...
  help: {
    ...
    robots: 'index, follow',
    image_url: `${BASE}/assets/images/og-help.jpg`,
  ...
  about: {
    ...
    robots: 'index, follow',
    image_url: `${BASE}/assets/images/og-about.jpg`,
    og_title: `About BeehiveMind: Beekeeping Software Built in Greece`,
    og_description: 'Who builds BeehiveMind and why it records by voice.',
    og_type: 'website',
    og_locale: 'en_US',
    og_site_name: SITE,
    twitter_card: 'summary_large_image',
    twitter_title: `About BeehiveMind: Beekeeping Software Built in Greece`,
  ...
  contact: {
    ...
    robots: 'index, follow',
    image_url: `${BASE}/assets/images/og-contact.jpg`,
  ...
  terms: {
    ...
    // Indexable, like /privacy: the legal pages are part of what tells a
    // crawler (and a store reviewer) that a real company stands behind the
    // product, and tools/build-sitemap.mjs lists whatever is not noindex.
    robots: 'index, follow',
    image_url: `${BASE}/assets/images/og-home.jpg`,
